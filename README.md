...
<p align="center">
  <a href="https://github.com/violet2code/magnify-snap/releases/download/v1.4.1/MagnifySnap-1.4.1-windows-x64-setup.exe"><img src="https://img.shields.io/badge/⬇%20Download%20for%20Windows-installer-4f8dfd?style=for-the-badge" alt="Download for Windows"></a>
  &nbsp;
  <a href="https://github.com/violet2code/magnify-snap/releases/download/v1.4.1/MagnifySnap-1.4.1-linux-x64.tar.gz"><img src="https://img.shields.io/badge/⬇%20Download%20for%20Linux-x64%20.tar.gz-3ddc97?style=for-the-badge" alt="Download for Linux"></a>
</p>

<p align="center">
  <sub>Prefer to install nothing? Take the
  <a href="https://github.com/violet2code/magnify-snap/releases/download/v1.4.1/MagnifySnap-1.4.1-windows-x64.exe">portable .exe</a>
  instead — same app, no installation.</sub>
</p>
...
- **Settings**: zoom level (125–800%), hold-to-peek level, cursor follow
  ...
  start at sign-in.
- **Two ways to install** — a single portable .exe that leaves no trace, or a
  small installer that puts Magnify.Snap in the Start menu so you can find and
  launch it like any other program (this is what `winget install` uses).
